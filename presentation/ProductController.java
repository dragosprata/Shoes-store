...
public class ProductController {
	 ...
	 @FXML
	    ...
	    @FXML 
	    private TextField newCuloareText;
	    @FXML
	    ...
	    @FXML
	    private TableColumn<Product, Integer> prodMarimeColumn;
	    @FXML
	    private TableColumn<Product, String> prodCuloareColumn;
	    ...
	    //Update product's colour with the colour which is written on newCuloareText field
	    @FXML
